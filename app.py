...
file_name = "D:\\New folder\\sample_data.csv"
def should_continue(state):
  ...
  try:
    if email_ids:
        print("Email sent to the recipient.")
        mail.logout()
        return "conversation handler"
    else:
        print("No email sent to the recipient.")
        mail.logout()
        return "continue"
...
"""
    ...
    user_input = input("Do you like response (yes/no): ").strip().lower()
    ...
    if user_input in yes_choices:
        ...
        try:
            ...
            #file_name = "/content/drive/My Drive/sample_data.csv"
            file_name = "D:\\New folder\\sample_data.csv"
            ...
            if latest_email_id != last_email_id:
                ...
                try:
                    ...
                    if "Re:" in subject:
                      ...
                      if user_input in yes_choices:
                      #if response:
                        send_email(f"Re: {subject}", response, from_email)
                        ...
                        if response.content == "yes":
                          ...
                          response = f"""
                                    ...
                                    Atul Verma
                          """
                          send_email(f"Alert: {subject}", response, alert_email)
                    #mail.logout()
...
lead_list = [
    ...
    {
        "Company Name": "Factspan",
        "Contact Name": "Sooryanarayanan Balasubramanian",
        "Job Title": "SPA ",
        "Email": "sooryanarayanan.b@factspan.com",
        "Phone Number": "+1 123 456 7890",
        "Industry": "Software",
        "Company Size": "51-200 employees",
        "Location": "California, USA",
    ...
    {
        "Company Name": "Factspan",
        "Contact Name": "Arush Agarwal",
        "Job Title": "SPA ",
        "Email": "arush.agarwal@factspan.com",
        "Phone Number": "+1 123 456 7890",
        "Industry": "Software",
        "Company Size": "51-200 employees",
        "Location": "California, USA",
